...
export default function PracticeTest({ questions, onComplete }: PracticeTestProps) {
  ...
  const handleNext = () => {
    if (isLast) return onComplete(score, questions.length);
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sky-700">
            ...
            <span className="font-semibold">Grade 1 Math Practice</span>
          </div>
