    ...
    <main className="flex-1 flex justify-center items-start p-6 md:-ml-40">
      <div className="w-full max-w-4xl">
        ...
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Mathematics</h1>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-6 bg-blue-700 text-white">
            <div className="flex items-center">
              ...
              <h2 className="text-2xl font-bold">Mathematics Practice Tests</h2>
            </div>
            <p className="mt-2 text-blue-100">
              Select your grade level to start practicing math problems.
            </p>
          </div>
              ...
              {classes.map((classNum) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Practice math for grade {classNum}</p>
                  </div>
